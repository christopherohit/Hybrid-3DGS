...
class NeRFDataset:
    def __init__(self, opt, device, type='train', downscale=1):
        ...
        # load face model type
        self.face_model_type = transform.get('face_model_type', 'BFM')  # Default to BFM for backward compatibility
        print(f'[INFO] Face model type: {self.face_model_type}')
